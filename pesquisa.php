...
<html>
	...
	<body>
		...
		<?php
			...
			$produtoPesquisado = $_POST['pesquisa'];
		?>
		...
		<div id="main">
		    	...
		    	if($produtoPesquisado == ""){
		    	    print "<h1 style='color: #49515a; text-align: center;'>Você buscou por todos</h1>";
		    	    
		    	} else{
    		    	print "<h1 style='color: #49515a; text-align: center;'>Você buscou por: $produtoPesquisado</h1>";
		    	}
		    	?>"
			...
			<div class="inner">
				...
				<div class="thumbnails">
					...
					#SQL para listagem
					$query = "SELECT * FROM produto where nomeProduto like '%".$produtoPesquisado."%'";
		...
		<div class="main" style="height:80px"></div>
		<!-- Footer -->
		<footer id="footer">
			<div class="inner">
				<h2>Troquei</h2>
