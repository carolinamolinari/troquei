...
<?php
	...
	if ($stm -> execute()) {
		...
		while ($row = $stm -> fetch()) {
			...
			$imagem1Produto = $row['imagem1Produto'];
			$imagem2Produto = $row['imagem2Produto'];
			$imagem3Produto = $row['imagem3Produto'];
		}
	}
...
<html lang = 'pt-br'>
	<head>
		<title>Troquei - Editar Produto</title>
	...
	<body>
		...
		<div class="cadastro" style="width: 500px; height: 1000px; margin: auto;">
			<form method="post" enctype="multipart/form-data" action="salvaEditaProduto.php?idProduto=<?php print $idProduto; ?>">
				<p style="font-family: 'Montserrat', Arial, Helvetica, sans-serif; font-weight: bold; color: #000000; font-size: 15px;">
					Informações do Produto:
				</p><br>
				<label style="width: 200px; height: 2px; display: inline-block;
				color: black; font-family: 'Montserrat', Arial, Helvetica, sans-serif; size: 15px;">Nome do Produto:</label>
				<input type="text" name="nomeProduto" value="<?php print $nomeProduto; ?>"/>
				...
				<select style="margin-bottom: 10px;" name="valorProduto" value="<?php print $valorProduto; ?>" placeholder="98">
					<option value="<?php print $valorProduto; ?> "> <?php print $valorProduto; ?>  </option>
				...
				<select name="estadoProduto" value="<?php print $estadoProduto; ?>">
				...
				<textarea wrap="hard" style="height:80px; resize: none;" name="descricaoProduto"><?php print $descricaoProduto; ?></textarea>
				...
				color: black; font-family: 'Open Sans', Arial, Helvetica, sans-serif; size: 15px;">Imagem 1:</label>
				<input name="arquivo1" type="file"/>
				<label style="width: 300px; height: 2px; display: inline-block;
				color: black; font-family: 'Open Sans', Arial, Helvetica, sans-serif; size: 15px;">Imagem 2:</label>
				<input name="arquivo2" type="file"/>
				<label style="width: 300px; height: 2px; display: inline-block;
				color: black; font-family: 'Open Sans', Arial, Helvetica, sans-serif; size: 15px;">Imagem 3:</label>
				<input name="arquivo3" type="file"/>
				<br> -->
				
				<br><label style="width: 300px; height: 2px; display: inline-block;
				color: black; font-family: 'Open Sans', Arial, Helvetica, sans-serif; size: 15px;">Imagens</label>
