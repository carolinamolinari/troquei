<header id="header">
			<nav class="left">
				...
				<?php
					...
					print "<nav id='menu'>
								<ul class='links'>
							<li>
								<a href='perfil.php' class='button alt' style='margin-top: 27px;'>$nome</a>
			...
			if (isset($_SESSION['user'])) {
				...
				<a href='cadastrarProduto.php' class='button alt' style='margin-top: 27px;'>Cadastrar Produto</a>
				<a href='solicitacaoTroca.php' class='button alt' style='margin-top: 27px;'>Solicitação de Troca</a>
				</nav>";
				...
				<a href='criarConta.php' class='button alt' style='margin-top: 27px;'>Criar conta</a>
			</nav>";
			}
			?>
		</header>
